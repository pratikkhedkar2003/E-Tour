...
const Password = () => {
  ...
  const onUpdatePassowrd = async (request) => await updatePassword(request);

  React.useEffect(() => reset(), [updateSuccess, reset]);
    ...
    <>
      ...
      {isSuccess && (
        <>
          ...
          <hr />
          <form
            onSubmit={handleSubmit(onUpdatePassowrd)}
              ...
              <div className="col-12">
                ...
                <div className="input-group has-validation">
                  ...
                  <input
                    ...
                    className={`form-control ' ${
                      form.errors.newPassword ? "is-invalid" : ""
              ...
              <div className="col-12">
                ...
                <div className="input-group has-validation">
                  ...
                  <input
                    ...
                    className={`form-control ' ${
                      form.errors.confirmNewPassword ? "is-invalid" : ""
